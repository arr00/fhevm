  ...
  describe('Unstaking', function () {
    ...
    describe('Release', function () {
      it('should transfer after cooldown complete', async function () {
        ...
        await expect(this.mock.tokensAwaitingRelease(this.staker1)).to.eventually.eq(ethers.parseEther('50'));
        ...
        await expect(this.mock.tokensAwaitingRelease(this.staker1)).to.eventually.eq(ethers.parseEther('0'));
      });
      ...
      it('should combine multiple complete withdrawals', async function () {
        ...
        await timeIncreaseNoMine(30);
        await this.mock.connect(this.staker1).unstake(this.staker1, ethers.parseEther('50'));
        await expect(this.mock.tokensAwaitingRelease(this.staker1)).to.eventually.eq(ethers.parseEther('100'));
